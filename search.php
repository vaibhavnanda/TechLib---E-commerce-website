                        ...
                        <ul>
                            ...
                            <div class="row-sm-3">
                                <div class="thumbnail">
                                    ...
                                    <?php endif; ?>
                                <div class="caption">
                                  <h5><center><b><?php echo $res['prod_name'];?></b></center></h5>
                                  <h6><a class="btn btn-success btn-round" title="Click for more details!" href="product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>View</a><medium class="pull-right">Rs. <?php echo $res['prod_price']; ?></medium></h6>
                                </div>
